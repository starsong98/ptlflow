...
checkpoints = [
    ...
    #["sintel"],    # VideoFlow-MOF
    #["sintel"],    # VideoFlow-BOF
]

# output directory
OUT_DIR = "./results/Samsung_dataset_warpruns"

# start iterating
for idx_model, model in enumerate(models):
    for checkpoint in checkpoints[idx_model]:
        for test_clip in test_clips:
            command = f"CUDA_VISIBLE_DEVICES=5 python infer_warpvis.py {model} --input_path {test_clip}  \
